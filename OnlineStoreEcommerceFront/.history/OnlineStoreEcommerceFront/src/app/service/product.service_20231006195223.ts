...
export class ProductService {
  ...
  getProductsByFourthLevelCategoryId(fourthlevelcategoryId: number): Observable<Product[]> {
    const url = `${this.baseURL}/getProductsByFourthLevelCategoryId/${fourthlevelcategoryId}/fourthlevelcategories`;
