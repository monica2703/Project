...
export class FourthLevelCatgeoryService {
  ...
  getFourthLevelCategoriesBySubSubcategoryId(subSubCategoryId: number): Observable<Fourthlevelcategory[]> {
    const url = `${this.baseURL}/subsubcategories/${subSubCategoryId}/fourthlevelcategories`;
    console.log('API URL:', url);
    return this.httpClient.get<Fourthlevelcategory[]>(url).pipe(
      catchError(error => {
