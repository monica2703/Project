...
export class UpdateSubSubCategoryComponent implements OnInit {
  ...
  constructor(private subSubCategoryService: SubSubCatgeoryService, private categoryService:CategoryService,
    ...
    updateSubCategoryIds(subSubCategoryId: number, subcategoryId: number): void {
      this.subSubCategoryService.setCategoryidToSubSubCategory(subSubCategoryId, subcategoryId)
        .subscribe(
          response => {
            console.log(response); 
          },
